...
\begin{multicols*}{3}
    ...
    \theorem{4.4.2 (Change of variable formula).}{
        Let $U \subset \R^2$ and $\bar{Y} \subset \Rn$ be compact subsets. Let $\varphi:U \rightarrow \R^2$ be a continuous map in $C^1$ and $f:A\subset \R^2 \to \R$ a continuous function. Furthermore $B \subset U$. We assume
        \begin{enumerate}[label=(\arabic*)]
    ...
    for any continuous function $f$ on $\bar{Y}$, we have
        $$
